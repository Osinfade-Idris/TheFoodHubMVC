...
namespace TheFoodHubMVC.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CartId,StaffId,Price,Quantity,TotalPrice")] Cart cart)
        {
            ...
            ViewData["StaffId"] = new SelectList(_context.Users, "Id", "Id", cart.StaffId);
            return View(cart);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("CartId,StaffId,Price,Quantity,TotalPrice")] Cart cart)
        {
            if (id != cart.CartId)
            {
                return NotFound();
